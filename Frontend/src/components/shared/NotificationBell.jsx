              ...
              notifications.map((n) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded-full ${TYPE_COLORS[n.type] || TYPE_COLORS.GENERAL}`}>
                      {n.type?.replace("_", " ")}
                    </span>
                    <p className="text-xs text-gray-700 mt-1 leading-relaxed line-clamp-2">{n.message}</p>
